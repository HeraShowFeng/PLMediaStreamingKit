...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _configLabel.font = FONT_LIGHT(14);
        [self.contentView addSubview:_configLabel];
        
        _listButton = [[UIButton alloc]initWithFrame:CGRectMake(28, 60, KSCREEN_WIDTH - 56, 30)];
        ...
        _listButton.titleLabel.font = FONT_MEDIUM(13);
        ...
        _lineView = [[UIView alloc]initWithFrame:CGRectMake(28, 98, KSCREEN_WIDTH - 56, 0.5)];
...
- (void)confugureListArrayCellWithConfigureModel:(PLConfigureModel *)configureModel {
    ...
    CGRect bounds = [configureModel.configuraKey boundingRectWithSize:CGSizeMake(KSCREEN_WIDTH - 56, 1000) options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObject:FONT_LIGHT(14) forKey:NSFontAttributeName] context:nil];
    if (bounds.size.height > 30) {
        _configLabel.frame = CGRectMake(28, 15, KSCREEN_WIDTH - 40, bounds.size.height);
        _listButton.frame = CGRectMake(28, 60 + bounds.size.height - 30, KSCREEN_WIDTH - 56, 30);
        _lineView.frame = CGRectMake(28, 98 + bounds.size.height - 30, KSCREEN_WIDTH - 56, 0.5);
    }
}
