...
- (void)confugureSegmentCellWithConfigureModel:(PLConfigureModel *)configureModel {
    ...
    if (bounds.size.height > 30) {
        _configLabel.frame = CGRectMake(28, 15, KSCREEN_WIDTH - 56, bounds.size.height);
        _segmentControl.frame = CGRectMake(28, 60 + bounds.size.height - 30, KSCREEN_WIDTH - 56, 30);
        _lineView.frame = CGRectMake(28, 98 + bounds.size.height - 30, KSCREEN_WIDTH - 56, 0.5);
    } else{
        _segmentControl.frame = CGRectMake(28, 60, KSCREEN_WIDTH - 56, 30);
    }
}
