...
- (void)layoutButtonsView {
    ...
    CGFloat viewHeight = 38 * titleArray.count;
    ...
    _buttonView = [[UIView alloc] initWithFrame:CGRectMake(0, 38, viewWidth, viewHeight)];
    [self addSubview:_buttonView];
    
    // 循环创建控件按钮
    for (NSInteger i = 0; i < titleArray.count; i++) {
        UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(0, 38 * i, viewWidth, 28)];
...
- (void)hideOrShowButtonView:(UIButton *)button {
    ...
    _buttonView.hidden = button.selected;
}
